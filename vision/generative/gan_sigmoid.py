...
def train_gan(G, D, input_noise_dim, train_loader, optimizer_G, optimizer_D, device):
    for idx, batch in (enumerate(train_loader)):
        ...
        # The output of generator is a sigmoid, similar to MNIST data.
        # Since the dataloader has a normalisation transform,
        # we apply the normalisation here on the fake_images as well
